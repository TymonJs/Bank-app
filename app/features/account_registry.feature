Feature: Account registry
    ...
    Scenario: User is able to create a second account
        ...
        And Account with pesel "12312312312" exists in registry
    ...
    Scenario: User is able to update name of already created account
        ...
        When I update "surname" of account with pesel: "12312312312" to "reeves"
        Then Account with pesel "12312312312" has "surname" equal to "reeves"
    ...
    Scenario: User is able to delete last account
        ...
        Then Account with pesel "12312312312" does not exist in registry
